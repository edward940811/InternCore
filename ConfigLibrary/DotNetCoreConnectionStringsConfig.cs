public static class DotNetCoreConnectionStringsConfig
{
    ...
    public static string ESHCloudsCore { get; set; } = @"Data Source=(LocalDb)\MSSQLLocalDB;Connection Timeout = 90;Initial Catalog=esh_core;Integrated Security=true"" providerName=""System.Data.SqlClient";
}