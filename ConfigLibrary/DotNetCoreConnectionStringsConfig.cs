public static class DotNetCoreConnectionStringsConfig
{
    ...
    public static string ESHCloudsCore { get; set; } = @"Server=tcp:wishing-developer.database.windows.net,1433;Initial Catalog=esh_core;Persist Security Info=False;User ID=wishingsoft;Password=Wishing_soft@99!@;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
}